...
export const principles: Principle[] = [
  ...
  },
  {
    ...
    body: "Role-based access added late is a filter over data the caller already fetched. Designed in, it is a property of the query. I put roles in the schema on day one — it is the cheapest it will ever be.",
